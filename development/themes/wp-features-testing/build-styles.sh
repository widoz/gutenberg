...
#
# It compiles the SCSS of the design system and of every block.
#
# It uses the Sass binary of the Gutenberg checkout. Pass `--watch` to keep
# Sass running.
...
"${sass_bin}" \
	...
	--load-path="${theme_dir}" \
	"$@" \
	"${theme_dir}/design-system/scss/element-defaults.scss:${theme_dir}/design-system/assets/element-defaults.css" \
